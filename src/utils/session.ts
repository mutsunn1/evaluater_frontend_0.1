...
/** Convert raw live-thinking entries to ThinkingStep[] */
...
/** Build SessionResult from endSession summary + confidence stats */
...
/** Default ConfidenceStats for initial state */
